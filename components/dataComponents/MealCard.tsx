...
const MealCard: React.FC<TheProps> = ({name, description, price, image, style}) => {
  return (
    <View style={[styles.itemCard, style]}>
        ...
        <View style={{paddingLeft:"1%", justifyContent:"space-between",width:"63%", }}>
            ...
            <TextComp style={{color:"#000000", fontSize:19}}>R{price}</TextComp>
        </View>
        <View style={{display:"flex", flexDirection:"column", justifyContent:"space-between"}}>
            <IconHolder style={{}} source={require("@/assets/Icons/optionsYellowIcon.png")} />
            <IconHolder source={require("@/assets/Icons/addCartYellowIcon.png")}/>
        </View>
    </View>
  )
}
